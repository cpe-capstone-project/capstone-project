...
func SetupThoughtRecordDatabase() {
	...
	records := []entity.ThoughtRecord{
		// เดือน 9/2025
		{Situation: "ความเครียดเรื่องงาน", Thoughts: "งานเยอะเกินไป", Behaviors: `"ถอนหายใจ"`, AlternateThought: "สามารถจัดลำดับความสำคัญได้", TagColors: "#faad14", UpdatedAt: time.Date(2025, 9, 1, 10, 0, 0, 0, utcPlus7), TherapyCaseID: 1, SituationTagID: 2, Emotions: []entity.Emotions{{Model: gorm.Model{ID: 18}}, {Model: gorm.Model{ID: 25}}}},
		...
		{Situation: "ผิดหวังเรื่องสอบ", Thoughts: "สอบได้คะแนนต่ำ", Behaviors: `"ร้องไห้"`, AlternateThought: "คะแนนสอบไม่ได้สะท้อนความสามารถทั้งหมด", TagColors: "#708090", UpdatedAt: time.Date(2025, 9, 9, 11, 0, 0, 0, utcPlus7), TherapyCaseID: 1, SituationTagID: 2, Emotions: []entity.Emotions{{Model: gorm.Model{ID: 25}}, {Model: gorm.Model{ID: 18}}}},
