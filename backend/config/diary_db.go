	...
	diaries := []entity.Diaries{
		{
			...
			UpdatedAt:     time.Now(),
			// TagColor1:     `"#FFC107", "#FF9800", "#FF5722"`,
			TagColor1:     "#FFC107",
			TagColor2:     "#FF9800",
			TagColor3:     "#FF5722",
			Confirmed:   true,	
		...
		},
		{
			...
			UpdatedAt:     time.Now().Add(-12 * time.Hour), // วันนี้ (ก่อนหน้า)
			// TagColors:     `"#4CAF50", "#8BC34A", "#CDDC39"`,
			TagColor1:    "#4CAF50",
			TagColor2:    "#8BC34A",
			TagColor3:    "#CDDC39",
			Confirmed:   true,
		...
		},
		{
			...
			// TagColors:     `"#E91E63", "#9C27B0", "#673AB7"`,
			TagColor1:    "#E91E63",
			TagColor2:    "#9C27B0",
			TagColor3:    "#673AB7",
			Confirmed:   false,
		...
		},
		{
			...
			// TagColors:     `"#03A9F4", "#00BCD4", "#009688"`,
			TagColor1:   "#03A9F4",
			TagColor2:   "#00BCD4",
			TagColor3:   "#009688",
			Confirmed:   true,
		...
		},
		{
			...
			// TagColors:     `"#795548", "#6D4C41", "#3E2723"`,
			TagColor1:   "#795548",
			TagColor2:   "#6D4C41",
			TagColor3:   "#3E2723",
			Confirmed:   true,
		...
		},
		{
			...
			// TagColors:     `"#FFEB3B", "#FFC107", "#FF9800"`,
			TagColor1:  "#FFEB3B",
			TagColor2:  "#FFC107",
			TagColor3:  "#FF9800",
			Confirmed:   true,
		...
		},
		{
			...
			// TagColors:     `"#2196F3", "#03A9F4", "#00BCD4"`,
			TagColor1:    "#2196F3",
			TagColor2:    "#03A9F4",
			TagColor3:    "#00BCD4",
			Confirmed:   false,
