...
const guidePages = [
  {
    ...
    borderColor: "#0ea5e9",
    content: [
      "บันทึกความคิดเป็นเครื่องมือช่วยบันทึกเหตุการณ์ ความคิด ความรู้สึก และพฤติกรรมที่เกิดขึ้น",
      "ช่วยให้เรามองเห็นรูปแบบความคิดที่บิดเบือน (Cognitive Distortions)",
      "เมื่อฝึกบ่อย ๆ จะช่วยให้เราเรียนรู้ที่จะท้าทายความคิดในขณะนั้นได้ทันที",
    ],
    example:
