...
type Diaries struct {
	...
	TagColor1 string `valid:"required~TagColor1 is required,hexcolor~TagColor1 must be a valid hex color"`
	TagColor2 string `valid:"required~TagColor2 is required,hexcolor~TagColor2 must be a valid hex color"`
	TagColor3 string `valid:"required~TagColor3 is required,hexcolor~TagColor3 must be a valid hex color"`
